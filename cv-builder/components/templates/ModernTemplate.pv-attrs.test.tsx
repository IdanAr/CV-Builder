...
describe('ModernTemplate data-pv-* attributes', () => {
  it('tags each rendered section with data-pv-section', () => {
    const { container } = render(
      <ModernTemplate data={data} meta={{ ...meta, sectionOrder: ['work', 'education', 'skills', 'custom:abc'] }} />
    )
  ...
  it('tags each entry within a section with data-pv-entry, indexed within its own section', () => {
    const { container } = render(<ModernTemplate data={data} meta={{ ...meta, sectionOrder: ['work'] }} />)
