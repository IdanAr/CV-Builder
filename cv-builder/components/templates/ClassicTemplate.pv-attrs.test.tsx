...
describe('ClassicTemplate data-pv-* attributes', () => {
  it('tags each rendered section with data-pv-section', () => {
    const { container } = render(
      <ClassicTemplate data={data} meta={{ ...meta, sectionOrder: ['work', 'education', 'skills', 'custom:abc'] }} />
    )
  ...
  it('tags each entry within a section with data-pv-entry, indexed within its own section', () => {
    const { container } = render(
      <ClassicTemplate data={data} meta={{ ...meta, sectionOrder: ['work'] }} />
    )
  ...
  it('tags custom section entries too', () => {
    const { container } = render(
      <ClassicTemplate data={data} meta={{ ...meta, sectionOrder: ['custom:abc'] }} />
    )
  ...
  it('does not tag a section with zero entries (it does not render at all)', () => {
    const { container } = render(
      <ClassicTemplate data={{}} meta={{ ...meta, sectionOrder: ['work'] }} />
    )
